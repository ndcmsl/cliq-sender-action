...
try {
    ...
    const senderName = (0, core_1.getInput)('sender-name');
    const senderImage = (0, core_1.getInput)('sender-image');
    const title = (0, core_1.getInput)('title');
    const tag = (0, core_1.getInput)('tag');
    const environment = (0, core_1.getInput)('environment');
    const rollback = (0, core_1.getInput)('rollback');
    ...
    if (tag == 'true') {
        ...
        let text = `Deployed ${ref == 'main' ? version : ref} in ${environment} ${emojis[environment] || ''}`;
        if (rollback == 'true')
    ...
    function sendMessage(message) {
        axios_1.default.post(webhook, message, {
            params: {
                zapikey: token,
            },
        });
        (0, core_1.setOutput)('message-json', JSON.stringify(message));
    }
}
catch (error) {
